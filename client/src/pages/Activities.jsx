    ...
    return (
        <>
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
                ...
                {/* Stats Section */}
                <div className="py-20 bg-gradient-to-br from-indigo-50 to-purple-100">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            <div className="group p-6 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl border border-blue-400 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-center">
                                <div className="text-3xl font-bold text-white mb-2">50+</div>
                                <div className="text-blue-100 text-sm">Annual Events</div>
                            </div>
                            <div className="group p-6 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl border border-green-400 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-center">
                                <div className="text-3xl font-bold text-white mb-2">15+</div>
                                <div className="text-green-100 text-sm">Sports Activities</div>
                            </div>
                            <div className="group p-6 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-xl border border-purple-400 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-center">
                                <div className="text-3xl font-bold text-white mb-2">20+</div>
                                <div className="text-purple-100 text-sm">Clubs & Societies</div>
                            </div>
                            <div className="group p-6 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-xl border border-orange-400 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 text-center">
                                <div className="text-3xl font-bold text-white mb-2">100%</div>
                                <div className="text-orange-100 text-sm">Participation</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="py-20 bg-white">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl font-bold text-slate-900 mb-4">Our Activities</h2>
                        ...
                        <div className="space-y-6">
                            {activities.map((activity) => (
                                <div
                                    key={activity.id}
                                    className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-2xl border border-slate-200 overflow-hidden transition-all duration-300 hover:shadow-xl transform hover:scale-[1.02]"
                                >
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-slate-600 mt-2">{activity.shortDescription}</p>
                                                </div>
                                            </div>
                                            <div className="ml-4">
